...
int main(void) {
  ...
  while(1) {
    ...
    */
    ...
    //tempData = readTemp();
    //tempDataDecimal = tempConvertDecimal(tempData);
    ...
    //char temperatureFinal[50];
    //sprintf(temperatureFinal, "Final Temperature: %f", tempDataDecimal);
    ...
    //sendString(USART, "<p>");
    //sendString(USART, temperatureFinal);
    //sendString(USART, "</p>");
